...
class Scanner:
    def __init__(self):
        ...
        self.listaErrores = []
        self.signos = ['?', '¿', '¡', '!', '.', ',', ':', ';']
        self.colores = ['AZUL', 'ROJO', 'AMARILLO', 'VERDE', 'NEGRO', 'ROSADO', 'ANARANJADO',
                        'MORADO', 'TURQUESA', 'CYAN', 'NARANJA', 'ROSA', 'PURPURA', 'CAFÉ', 'CAFE', 'GRIS']
        self.contador = 0
        self.operaciones = []
        self.colortitulo = ''
        self.colordescrip = ''
    ...
    def Operar(self):
                ...
                if self.listaTokens[i].tipo == 'TK_OPERACION':
                    ...
                    if t1.lexeme == 'SUMA':
                        ...
                        for uwu in range(len(listaNums)):
                            listaPotenciaSimps.append(
                                float(listaNums[uwu].lexeme))
                        ...
                        for xd in range(len(listaNums)):
                            listaInversoSimps.append(
                                float(listaNums[xd].lexeme))
                        ...
                        for unu in range(len(listaNums)):
                            listaTangenteSimps.append(
                                float(listaNums[unu].lexeme))
        ...
        for i in self.operaciones:
            print("Tipo: ", i.texto, 'Números: ', i.numeros,
                  'Total: ', i.total, 'No. Operaciones: ', i.contador)
            ...
            if self.listaTokens[i].tipo == 'TK_ESTILO':
                ...
                while (contador <= i+23):
                    ...
                    if (self.listaTokens[contador].tipo) == 'TK_TITULO':
                        ...
                        contador += 10
                break
        print(self.colortitulo, self.tamaniotitulo, self.colordescrip,
              self.tamaniodescrip, self.colorcontenido, self.tamniocontenido)
