...
def window_mainMenu():
    ...
    file_menu.add_command(label="Guardar Como", command=saveas, font=(
        "Courier 10 bold"), background="#E4E3FF")
    file_menu.add_separator()
    file_menu.add_command(label="Analizar", command=scanner, font=(
        "Courier 10 bold"), background="#E4E3FF")
    file_menu.add_separator()
    file_menu.add_command(label="Errores", command=report, font=(
        "Courier 10 bold"), background="#E4E3FF")
    file_menu.add_separator()
...
def reportOP():
    global ScannerGG
    generararchivoOp(ScannerGG.operaciones, ScannerGG.colorcontenido, ScannerGG.tamniocontenido, ScannerGG.colordescrip,
                     ScannerGG.tamaniodescrip, ScannerGG.descripcionn, ScannerGG.colortitulo, ScannerGG.tamaniotitulo)
